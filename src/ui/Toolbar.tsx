...
export function Toolbar({
  ...
  return (
    <div className="toolbar">
      ...
      {gitBranch && (
        <span
          style={{ color: 'var(--git-branch, var(--text-muted))', fontSize: 11, marginLeft: 6 }}
        >
      ...
      <button onClick={() => onCycleModel('prev')} title="Previous model">
        ◀
      </button>
      ...
      <select value={thinking} onChange={(e) => onSetThinking(e.target.value as ThinkingLevel)}>
        {LEVELS.map((l) => (
