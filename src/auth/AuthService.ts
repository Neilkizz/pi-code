...
export class AuthService implements vscode.Disposable {
  ...
  async login(): Promise<void> {
    ...
    vscode.window.showInformationMessage('Pi login — complete the flow in the browser Pi opened.');
  }
  ...
  private async ensureSession(): Promise<import('../session/PiSession').PiSession> {
